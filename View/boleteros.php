...
<div class="row">
    <ol class="breadcrumb">
        ...
        <li class="active">Boleteros</li>
    </ol>
</div><!--/.row-->

<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Reporte General Boleteros</h1>
    </div>
</div><!--/.row-->
<div>
    <div>
        <button class="btn btn-primary" data-toggle="modal" data-target="#modalNuevoBoletero">Nuevo Boletero</button>
    </div>
    <div class="form-group text-center">
        ...
        if(isset($_GET['successEdit'])){
            ...
            ?>
            <div class="alert alert-danger">
                Ha ocurrido un error al actualizar el Usuario, por favor intente de nuevo.
            </div>
            <?php
        }
...
<div class="modal fade" id="modalNuevoBoletero" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form enctype="multipart/form-data" action="./Controller/HomeController.php?page=boleteros" method="POST">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Agregar Boletero</h5>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <input type="file" class="form-control-file" accept="image/*" accept="image/*" id="Foto" name="uploadedfile">
                        </div>
                        <div class="row col-lg-8">
                            ...
                            <input type="hidden" value="2" name="idTipoEmpleado" name="idTipoEmpleado">
        ...
        <div class="modal-content">
            <form enctype="multipart/form-data" action="./Controller/HomeController.php?page=boleteros" method="POST">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg-4">
                            <img id="imgInfoE" src="assets/img/users/default.jpg" style="width: 100%; height: auto;">
                    ...
                    <div role="tabpanel">
                        ...
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane active" id="uploadTab1">
                                <div class="row">
                                    <div class="col-lg-4">
                                        <img src=""  id="imgInfo" style="width: 100%; height: auto;">
                                    </div>
                                    <div class="row col-lg-8">
                                        <div class="col-lg-12">
                                            <label>Nombre</label>
...
<div class="modal" id="modalObservacionEdit" tabindex="-1" role="dialog">
    <div class="modal-dialog"  role="document">
        <div class="modal-content">
            ...
            <form action="./Controller/HomeController.php?page=boleteros" method="post">
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-7">
                            <label>Observacion</label>
        ...
        <form enctype="multipart/form-data" action="./Controller/HomeController.php?page=boleteros" method="post">
            <div class="row modal-footer">
                <div class="col-md-12">
                    ...
                    <input type="file" accept="image/*, video/*" class="form-control" id="uploadedfile" name="uploadedfile">
                </div>
                <div class="modal-footer">
