...
$boletero =$empleado->getAdministrativos();
...
?>
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Reporte General Administrativos</h1>
        </div>
    </div><!--/.row-->

    <div>
        <div>
            <button class="btn btn-primary" data-toggle="modal" data-target="#modalNuevoBoletero">
                Nuevo Personal
            </button>
        </div>
        ...
        <div class="form-group text-center">
            ...
            else if(isset($_GET['errorObservacionNoImagen'])){
            ?>
            <div class="alert alert-warning">
                La incidencia se ha <strong>Guardado con EXITO</strong> pero hubo un problema al guardar la imagen
            </div>
            <?php
            }
            ?>
    ...
    <div class="modal fade" id="modalNuevoBoletero" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <form enctype="multipart/form-data" action="./Controller/HomeController.php?page=administrativo" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="row col-md-8">
                                ...
                                <input type="hidden" value="4" name="idTipoEmpleado" name="idTipoEmpleado">
                                <input type="hidden" value="4" id="id" name="id">
                            </div>
    ...
    <div class="modal" id="modalObservacionEdit" tabindex="-1" role="dialog">
        <div class="modal-dialog"  role="document">
            <div class="modal-content">
                ...
                <form action="./Controller/HomeController.php?page=administrativo" method="post">
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-7">
                                <label>Observacion</label>
